...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::connections::connection_adopt,
            ...
            commands::identities::identity_adopt,
            ...
            commands::snippets::snippet_folder_adopt,
            ...
            commands::port_forwarding_rules::pf_rule_adopt,
